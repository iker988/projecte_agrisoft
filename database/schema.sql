...
CREATE TABLE IF NOT EXISTS DOCUMENTS_TREBALLADOR (
...
CREATE TABLE IF NOT EXISTS TREBALLADORS_EQUIPS (
    idTreballador INT,
    idEquip INT,
    rol VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS ASSIGNACIONS_TASCA (
...
CREATE TABLE IF NOT EXISTS VACANCES_PERMISOS (
...
CREATE TABLE IF NOT EXISTS SECTOR_CULTIU (
...
CREATE TABLE IF NOT EXISTS VARIETAT (
...
CREATE TABLE IF NOT EXISTS PLANTADA (
...
CREATE TABLE IF NOT EXISTS FILA_ARBRES (
...
CREATE TABLE IF NOT EXISTS SEGUIMENT_SECTOR (
...
CREATE TABLE IF NOT EXISTS ESTOC_PRODUCTE (
...
CREATE TABLE IF NOT EXISTS TRACTAMENT_PRODUCTE (
    idTractament INT,
    idProducte INT,
...
CREATE TABLE IF NOT EXISTS FERTILITZACIO (
...
CREATE TABLE IF NOT EXISTS FERTILITZACIO_PRODUCTE (
    idFertilitzacio INT,
    idProducte INT,
    quantitatAplicada DECIMAL(10,2),
...
CREATE TABLE IF NOT EXISTS PLANIFICACIO_TRACTAMENT (
...
CREATE TABLE IF NOT EXISTS PLANIFICACIO_FERTILITZACIO (
    idPlanificacio INT PRIMARY KEY,
    idSector INT,
    dataPrevista DATE,
...
CREATE TABLE IF NOT EXISTS QUADERN_EXPLOTACIO (
...
CREATE TABLE IF NOT EXISTS APLICACIO_HERBICIDA (
...
CREATE TABLE IF NOT EXISTS LOT_PRODUCCIO (
...
CREATE TABLE IF NOT EXISTS CONTROL_QUALITAT (
...
CREATE TABLE IF NOT EXISTS LOT_CLIENT (
    idLot INT,
    idClient INT,
    dataAssignacio DATE,
    quantitat DECIMAL(10,2),
...
CREATE TABLE IF NOT EXISTS PREVISIO_COLLITA (
